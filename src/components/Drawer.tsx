...
import { approvedActivity } from './HomeData';

const { approvedSources, approvedActions } = approvedActivity;
...
const AppDrawer = React.memo((props: AppDrawerProps) => {
  ...
  const { updateLastClicked, modelNames } = useContext(DrawerContext);
